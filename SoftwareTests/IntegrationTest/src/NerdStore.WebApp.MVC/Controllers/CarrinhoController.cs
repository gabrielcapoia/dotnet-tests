...
namespace NerdStore.WebApp.MVC.Controllers
{
    ...
    public class CarrinhoController : ControllerBase
    {
        ...
        public async Task<IActionResult> AdicionarItem(Guid id, int quantidade)
        {
            ...
            var command = new InsertOrderItemCommand(ClienteId, produto.Id, produto.Nome, quantidade, produto.Valor);
        ...
        public async Task<IActionResult> RemoverItem(Guid id)
        {
            ...
            var command = new DeleteOrderItemCommand(ClienteId, id);
            await _mediatorHandler.Send(command);
        ...
        public async Task<IActionResult> AtualizarItem(Guid id, int quantidade)
        {
            ...
            var command = new UpdateOrderItemCommand(ClienteId, id, quantidade);
            await _mediatorHandler.Send(command);
        ...
        {
            var command = new ApplyVoucherOrderCommand(ClienteId, voucherCodigo);
            await _mediatorHandler.Send(command);
